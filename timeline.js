...
function pageLoaded() {
  ...
  klon.querySelector("text").textContent = "RYPARKEN";
  klon2.querySelector("text").textContent = "BISPEBJERG";
  klon3.querySelector("text").textContent = "NØRREBRO";
  klon4.querySelector("text").textContent = "FUGLEBAKKEN";
  klon5.querySelector("text").textContent = "GRØNDAL";
  klon6.querySelector("text").textContent = "FLINTHOLM";
  klon7.querySelector("text").textContent = "KB HALLEN";
  klon8.querySelector("text").textContent = "ÅLHOLM";
  klon9.querySelector("text").textContent = "DANSHØJ";
  klon10.querySelector("text").textContent = "VIGERSLEV ALLÉ";
  klon11.querySelector("text").textContent = "NYELLEBJERG";
